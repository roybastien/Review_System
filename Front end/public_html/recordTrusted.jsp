...
<%
String isTrusted = request.getParameter("trust");
...
<nav class="navbar navbar-default navbar-custom" role="navigation">
  ...
  <div class="container">
    <div class="row">
      ...
      <p></p>
      <form class="form-signin" align="center" method="post" action="recordTrusted.jsp">
        <label for="user">Please enter the user whom you want to trust or untrust.</label>
        <input type="text" name="user" id="user" class="form-control" placeholder="<%=session.getAttribute("username")%>" required>
          <p></p>
          <label for="attributeDrop">What would you like to do?</label>
          <select class="form-control" name="trust" id="attributeDrop">
  ...
  String trustIn = request.getParameter("trust");
  String success = "";
  Boolean admn;
  ...
  String responseBack = fs.trustSomeoneWeb(usr, userIn, trustIn);
  if(responseBack.contains("Success")){
    success = "Success, your trust has been entered!";
  }
  else if (responseBack.contains("Duplicate")){
    success = "Sorry, your information could not be entered.\nYou have already trusted that user.";
  }
  else{
    success = "Sorry, your information could not be entered.\n" + responseBack;
  }
