...
<nav class="navbar navbar-default navbar-custom" role="navigation">
  ...
  <div class="container">
    <div class="row">
      <h2 align="center"><%=session.getAttribute("username")%>, which point of interest do you want to review?</h2>
      <p></p>
      <form class="form-signin" align="center" method="post" action="recordFeedback.jsp">
        ...
        <input type="text" name="POIname" id="POIname" class="form-control" placeholder="Starbucks" required>
          <p></p>
          <label for="rating">How would you rate it? (1 - 10)</label>
          <input type="text" name="rating" id="rating" class="form-control" placeholder="5" required>
          <p></p>
          <label for="rating">Please provide some feedback</label>
  ...
  String responseBack = fs.recordFeedbackWeb(usr, poiNameIn, ratingIn, commentIn);
