...
<nav class="navbar navbar-default navbar-custom" role="navigation">
  ...
  <div class="container">
    <div class="row">
      <h2 align="center"><%=session.getAttribute("username")%>, how many users would you like to award?</h2>
      <p></p>
      <form class="form-signin" align="center" method="post" action="giveAwards.jsp">
  ...
  String responseBack = fs.giveAwardsWeb(limit);
