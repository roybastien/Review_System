  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <h2>
          <%=session.getAttribute("username")%>, what would you like to edit?
        </h2>
        <div class="text-center">
          <form class="form-signin" align="center" method="post" action="editPOI.jsp">
            ...
            <p></p>
            <label for="attributeDrop">Attribute</label>
            <select class="form-control" name="attribute" id="attributeDrop">
            ...
            <input type="text" name="newValue" id="newValue" class="form-control" placeholder="URL, Address, etc" required>
              <p></p>
...
<%
  ...
  String attributeValueIn = request.getParameter("attribute");
  String newValueIn = request.getParameter("newValue");
  ...
  String responseBack = fs.editPOIJSP(poiNameIn, attributeValueIn, newValueIn);
  String success = "";
