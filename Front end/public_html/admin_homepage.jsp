  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <a href="newPOI.jsp" class="btn btn-md btn-info" role="button" position="center">Enter a new POI</a>
        <p></p>
      ...
      <div class="col-sm-4">
        <div class="text-center">
        <a href="editPOI.jsp" class="btn btn-md btn-info" role="button">Edit a POI</a>
        <p></p>
        ...
        <p></p>
        <a href="giveAwards.jsp" class="btn btn-md btn-info" role="button">Give Awards</a>
        <p></p>
      </div>
      </div>
      <div class="col-sm-4">
